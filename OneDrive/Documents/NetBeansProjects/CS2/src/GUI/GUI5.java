/*
 * GUI 5 is like GUI 4 except that the central region is replaced by
 ...
 * of a big deal. The GUI responds!
 *
...
public class GUI5 {
    ...
    public class KFrame extends JFrame implements ActionListener {
        ...
        //This method serves to implement the ActionListener inteface
        @Override
